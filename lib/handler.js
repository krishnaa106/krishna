...
async function handleMessage(sock, msg) {
    ...
    try {
        ...
        try {
            permissions = loadJson("db/permissions.json") || { publicJids: [], commandAccess: {} };
        ...
        const isAllowedChat = permissions.publicJids.includes(jid); // group or DM
        const isAllowedUser = permissions.publicJids.includes(senderJid); // specific user
